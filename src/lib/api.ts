...
export const reportsAPI = {
  generate: (filters?: { filterStartDate?: string; filterEndDate?: string }) =>
    api.post<GenerateReportResponse>('/user/reports/generate', filters || {}),

  getStatus: () => api.get<ReportStatus>('/user/reports/status'),

  getHistory: (limit?: number) =>
    api.get<Report[]>('/user/reports/history', { params: { limit } }),
};
